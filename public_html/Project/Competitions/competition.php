    ...
    <form method="POST">
        <div class="col-12 col-md-9 col-lg-7 col-xl-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control form-control-lg" id="Sreward" type="number" name="starting_reward" oninput="updateCost()" min="1" />
            </div>
            <div class="mb-3">
                <label for="ms" class="form-label">Min. Score</label>
                <input class="form-control form-control-lg" id="ms" name="min_score" type="number" min="1" />
            </div>
            <div class="mb-3">
                <label for="mp" class="form-label">Min. Participants</label>
                <input class="form-control form-control-lg" id="mp" name="min_participants" type="number" min="3" />
            </div>
            <div class="mb-3">
                <label for="jc" class="form-label">Join Fee</label>
                <input class="form-control form-control-lg" id="jc" name="join_fee" type="number" oninput="updateCost()" min="0" />
            </div>
            <div class="mb-3">
                <label for="duration" class="form-label">Duration (in Days)</label>
                <input class="form-control form-control-lg" id="duration" name="duration" type="number" min="3" />
            </div>
            <div class="mb-3">
                <label for="po1" class="form-label">Frist PLace (%)</label>
                <input class="form-control form-control-lg" id="po1" name="first_place_per" type="number">
            </div>
            <div class="mb-3">
                <label for="po2" class="form-label">Second Place (%)</label>
                <input class="form-control form-control-lg" id="po" name="second_place_per" type="number">
            </div>
            <div class="mb-3">
                <label for="po3" class="form-label">Third Place (%)</label>
                <input class="form-control form-control-lg" id="po3" name="third_place_per" type="number">
            </div>
            <div class="mb-3">
